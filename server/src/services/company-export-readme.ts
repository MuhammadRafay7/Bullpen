 ...
 */
import type { CompanyPortabilityManifest } from "@bullpen/shared";
...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an [Agent Company](https://agentcompanies.io) package from [Bullpen](https://paperclip.ing)");
  lines.push("");
