/**
 * PluginEventBus — typed in-process event bus for the Bullpen plugin system.
 *
 * Responsibilities:
...
import type { PluginEventType } from "@bullpen/shared";
import type { PluginEvent, EventFilter } from "@bullpen/plugin-sdk";
