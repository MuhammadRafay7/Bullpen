...
import type { ToolRunContext, ToolResult, ExecuteToolParams } from "@bullpen/plugin-sdk";
...
export interface PluginToolRegistry {
   ...
   */
  registerPlugin(pluginId: string, manifest: BullpenPluginManifestV1, pluginDbId: string): void;
