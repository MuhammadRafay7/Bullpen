...
function registerResolvedVarToken(varName, fallbackRaw, sourceNote) {
  // varName like "--bullpen-code-highlight-bg" -> token name
  // "code-highlight-bg-resolved" (strip the leading "--bullpen-" prefix
  ...
  const bare = varName.replace(/^--bullpen-/, "").replace(/^--/, "");
