...
const STORIES = [
  {
    id: "bullpen-source-issue-recovery--recovery-action-card-states",
    label: "card-states",
  },
  {
    id: "bullpen-source-issue-recovery--inbox-row-chips",
    label: "inbox-rows",
  },
  {
    id: "bullpen-source-issue-recovery--blocker-notice-recovery-indicators",
    label: "blocker-notice",
  },
  {
    id: "bullpen-source-issue-recovery--active-run-panel-recovery-chips",
