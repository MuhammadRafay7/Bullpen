 ...
 *
 * Opt-in mechanism: a line containing `bullpen:allow-git-push` (typically
 * inside a `// bullpen:allow-git-push: <reason>` comment on the line itself
...
export const ALLOW_MARKER = "bullpen:allow-git-push";
