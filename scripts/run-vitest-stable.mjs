...
const nonServerProjects = [
  "@bullpen/shared",
  "@bullpen/skills-catalog",
  "@bullpen/db",
  "@bullpen/adapter-utils",
  "@bullpen/adapter-codex-local",
  "@bullpen/adapter-opencode-local",
  "@bullpen/plugin-sdk",
...
const generalWorkspacesAProjects = ["@bullpen/ui", "bullpen"];
...
function runVitest(args, label) {
  ...
  const env = {
    ...process.env,
    NODE_ENV: "test",
    BULLPEN_HOME: path.join(testRoot, "h"),
    BULLPEN_INSTANCE_ID: `vt-${process.pid}-${invocationIndex}`,
    TMPDIR: path.join(testRoot, "t"),
  };
  mkdirSync(env.BULLPEN_HOME, { recursive: true });
