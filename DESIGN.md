...
3. **Domain tier** — match-chip tokens `--chip-match-*`, annotation highlights `--bullpen-doc-annotation-highlight-*`, plus motion/typography tokens.
