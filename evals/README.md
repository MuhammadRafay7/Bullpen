...
Eval framework for testing Bullpen agent behaviors across models and prompt versions.
...
Phase 0 covers narrow behavior evals for the Bullpen heartbeat skill:
