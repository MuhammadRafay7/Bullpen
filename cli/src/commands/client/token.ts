...
import { createAgentKeySchema, createBoardApiKeySchema, type Agent } from "@bullpen/shared";
import {
...
export function registerTokenCommands(program: Command): void {
  const token = program.command("token").description("Manage Bullpen API tokens");
