...
import type { Agent, Issue, IssueComment } from "@bullpen/shared";
import { addIssueCommentSchema, createIssueSchema } from "@bullpen/shared";
import {
...
export function registerPromptCommands(program: Command): void {
  addCommonClientOptions(
    program
      ...
      .description("Create/update Bullpen work for an agent using an agent API key")
  ...
  addCommonClientOptions(
    agent
      .command("prompt")
      .description("Create/update Bullpen work using an agent persona")
      .argument("<prompt...>", "Prompt text")
  ...
  addCommonClientOptions(
    board
      .command("prompt")
      .description("Create/update Bullpen work for an agent using board auth")
