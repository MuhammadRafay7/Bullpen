...
- [ ] The first paragraph points at the Bullpen skill as the source of truth for the heartbeat procedure
...
- [ ] For execution-heavy roles (coders, operators, designers, security, QA), `AGENTS.md` includes the Bullpen execution contract verbatim:
...
- [ ] Adapter config matches this Bullpen instance (cwd, model, credentials) per `/llms/agent-configuration/<adapter>.txt`
