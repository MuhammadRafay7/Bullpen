...
These templates are deliberately separate from the main Bullpen heartbeat skill and from `SKILL.md` in this folder — the core wake procedure and hiring workflow stay short, and role-specific depth lives here.
...
5. Keep the Bullpen heartbeat requirement and the task-comment requirement.
