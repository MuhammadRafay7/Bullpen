...
This is intentionally separate from the normal Bullpen dev image.
...
```sh
review-checkout-pr bullpen/bullpen 432
cd /work/checkouts/bullpen-bullpen/pr-432
```
...
## Preview the Bullpen app from the PR
...
- Bullpen's embedded PostgreSQL and local storage stay inside the container home volume via `BULLPEN_HOME=/home/reviewer/.bullpen-review`.
