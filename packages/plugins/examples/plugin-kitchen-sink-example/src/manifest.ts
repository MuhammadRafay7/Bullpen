...
const manifest: BullpenPluginManifestV1 = {
  ...
  description: "Reference plugin that demonstrates the current Bullpen plugin API surface, UI surfaces, bridge actions, events, jobs, webhooks, tools, local workspace access, and runtime diagnostics in one place.",
  author: "Bullpen",
  ...
  tools: [
    ...
    },
    {
      ...
      description: "Summarizes the current company using the Bullpen domain APIs.",
      parametersSchema: {
        type: "object",
        properties: {},
      },
