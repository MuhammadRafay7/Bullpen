import type { PluginLauncherRegistration } from "@bullpen/plugin-sdk";

export const PLUGIN_ID = "bullpen-kitchen-sink-example";
...
export const DEFAULT_CONFIG = {
  ...
  workspaceScratchFile: ".bullpen-kitchen-sink-demo.txt",
} as const;
