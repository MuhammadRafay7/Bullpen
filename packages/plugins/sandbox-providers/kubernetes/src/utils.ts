...
// Namespace names are capped at 63 chars (RFC 1123). The default "bullpen-"
...
export function bullpenLabels(input: LabelsInput): Record<string, string> {
  return {
    "bullpen.io/run-id": input.runId,
    "bullpen.io/agent-id": input.agentId,
    "bullpen.io/company-id": input.companyId,
    "bullpen.io/adapter": input.adapterType,
