...
const PLUGIN_ID = "bullpen.fake-sandbox-provider";
...
const manifest: BullpenPluginManifestV1 = {
  ...
  description:
    "First-party deterministic sandbox provider plugin for exercising Bullpen provider-plugin integration without external infrastructure.",
  author: "Bullpen",
