/**
 * Bullpen plugin UI SDK — types for plugin frontend components.
 *
 * Plugin UI bundles import from `@bullpen/plugin-sdk/ui`.  This subpath
...
/**
 * Options for host-managed Bullpen navigation from plugin UI.
 */
...
export interface HostNavigation {
  /**
   * Resolve a Bullpen-internal path using the active company prefix.
   *
