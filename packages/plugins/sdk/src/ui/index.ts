/**
 * `@bullpen/plugin-sdk/ui` — Bullpen plugin UI SDK.
 *
 ...
 *
 * The worker-side SDK is available from `@bullpen/plugin-sdk` (root).
 *
 ...
 * import type { PluginWidgetProps } from "@bullpen/plugin-sdk/ui";
 *
 ...
 * - `useHostNavigation()` — navigate Bullpen-internal links through the host router
