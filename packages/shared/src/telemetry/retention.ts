 ...
 *
 * Defines the retention class for each Bullpen telemetry event and the
 ...
 * that are not part of the shared generated `BullpenEventName` type. When an
 ...
 *   External-system event (Codex CLI) — not yet in BullpenEventName.
