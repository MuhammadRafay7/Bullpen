...
export interface BullpenAgentCreatedDimensions {
agent_id: string
agent_role: ("ceo" | "cto" | "cmo" | "cfo" | "security" | "engineer" | "designer" | "pm" | "qa" | "devops" | "researcher" | "general" | "other")
}

export interface BullpenAgentFirstHeartbeatDimensions {
agent_id: string
agent_role: ("ceo" | "cto" | "cmo" | "cfo" | "security" | "engineer" | "designer" | "pm" | "qa" | "devops" | "researcher" | "general" | "other")
}

export interface BullpenAgentTaskCompletedDimensions {
...
export interface BullpenCompanyImportedDimensions {
source_type: ("local_path" | "github" | "url" | "catalog" | "skills_sh" | "unknown")
source_ref?: string
source_ref_hashed?: boolean
}

export interface BullpenErrorHandlerCrashDimensions {
error_code: string
}

export interface BullpenGoalCreatedDimensions {
goal_level: ("company" | "team" | "agent" | "task" | "other")
}

export interface BullpenInstallCompletedDimensions {
adapter_type: ("process" | "http" | "acpx_local" | "claude_local" | "codex_local" | "cursor_cloud" | "gemini_local" | "hermes_gateway" | "hermes_local" | "opencode_local" | "pi_local" | "cursor" | "openclaw_gateway" | "grok_local" | "other")
}

export interface BullpenInstallStartedDimensions {

}

export interface BullpenInteractionResolvedDimensions {
...
export interface BullpenProjectCreatedDimensions {

}

export interface BullpenRoutineCreatedDimensions {

}

export interface BullpenRoutineRunDimensions {
source: ("schedule" | "manual" | "api" | "webhook" | "other")
status: ("received" | "coalesced" | "skipped" | "issue_created" | "completed" | "failed" | "other")
}

export interface BullpenSkillImportedDimensions {
source_type: ("local_path" | "github" | "url" | "catalog" | "skills_sh" | "unknown")
skill_ref?: string
}

export type BullpenEventName =
  | "agent.created"
...
export interface EventDimensionsMap {
  "agent.created": BullpenAgentCreatedDimensions;
  "agent.first_heartbeat": BullpenAgentFirstHeartbeatDimensions;
  "agent.task_completed": BullpenAgentTaskCompletedDimensions;
  "company.imported": BullpenCompanyImportedDimensions;
  "error.handler_crash": BullpenErrorHandlerCrashDimensions;
  "goal.created": BullpenGoalCreatedDimensions;
  "install.completed": BullpenInstallCompletedDimensions;
  "install.started": BullpenInstallStartedDimensions;
  "interaction.resolved": BullpenInteractionResolvedDimensions;
  "project.created": BullpenProjectCreatedDimensions;
  "routine.created": BullpenRoutineCreatedDimensions;
  "routine.run": BullpenRoutineRunDimensions;
  "skill.imported": BullpenSkillImportedDimensions;
}

export const BULLPEN_EVENTS = {
...
export const BULLPEN_ENUM_DESCRIPTIONS = {
  "agent.created": {
    "agent_role": {
  ...
  "company.imported": {
    "source_type": {
      ...
      "catalog": "Import source came from a Bullpen catalog entry.",
  ...
  "interaction.resolved": {
    ...
    "resolved_by_kind": {
      ...
      "system": "Bullpen resolved the interaction automatically.",
...
export interface BullpenTelemetryEvent<K extends BullpenEventName = BullpenEventName> {
name: K
occurredAt: string
dimensions: EventDimensionsMap[K]
}

export type AnyBullpenTelemetryEvent = {
  [K in BullpenEventName]: BullpenTelemetryEvent<K>
}[BullpenEventName];

export interface BullpenTelemetryBatch {
app: "bullpen"
schemaVersion: typeof SCHEMA_VERSION
installId: string
version?: string
events: AnyBullpenTelemetryEvent[]
}

export function makeEvent<K extends BullpenEventName>(
  name: K,
  dimensions: EventDimensionsMap[K],
  occurredAt: string
): BullpenTelemetryEvent<K> {
  return { name, occurredAt, dimensions };
}

export function makeBatch(
  installId: string,
  events: readonly AnyBullpenTelemetryEvent[],
  version?: string
): BullpenTelemetryBatch {
  return {
    app: "bullpen",
