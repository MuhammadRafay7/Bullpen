...
import * as generatedTelemetry from "./generated/bullpen-telemetry.js";
...
describe("telemetry README contract", () => {
  it("documents generated event helper exports that exist", () => {
    ...
    expect(readme).not.toContain("createBullpenTelemetryEvent");
    expect(readme).not.toContain("createBullpenTelemetryEnvelope");
  });
});
