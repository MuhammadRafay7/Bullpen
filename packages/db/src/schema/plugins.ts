...
import type { PluginCategory, PluginStatus, BullpenPluginManifestV1 } from "@bullpen/shared";
...
export const plugins = pgTable(
  "plugins",
  {
    ...
    manifestJson: jsonb("manifest_json").$type<BullpenPluginManifestV1>().notNull(),
