...
key: bullpen/optional/content/release-announcement
recommendedForRoles:
  - devrel
  - product
  - writer
...
## Bullpen Cases output

When this skill runs inside Bullpen and `experimental.enableCases` is enabled,
...
Use `skills/bullpen/references/cases.md` for the API contract. Include
`X-Bullpen-Run-Id` on writes when `BULLPEN_RUN_ID` is set. If the API returns
...
{
  "caseType": "release",
  "key": "bullpen-release:vYYYY.MDD.P",
  "title": "Bullpen vYYYY.MDD.P release",
  "status": "in_progress",
  "fields": {
    "schema_version": 1,
    "version": "vYYYY.MDD.P",
...
{
  "caseType": "blog_post",
  "key": "bullpen-release:vYYYY.MDD.P:blog-post",
  "title": "Bullpen vYYYY.MDD.P launch post",
  "status": "in_review",
  "parentCaseId": "<release-case-id>",
  "fields": {
    "schema_version": 1,
    "version": "vYYYY.MDD.P",
    "slug": "bullpen-vYYYY-MDD-P",
...
```json
{
  ...
  "key": "bullpen-release:vYYYY.MDD.P:tweet-storm",
  "title": "Bullpen vYYYY.MDD.P tweet storm",
  "status": "in_review",
  "parentCaseId": "<release-case-id>",
  "fields": {
    "schema_version": 1,
