...
Use this reference when generating or reviewing deterministic Bullpen capsule identicons/profile pills. Prototype source paths, when the Bullpen content repository is available:

- `bullpen-content/design/PAP-11825/bullpen-capsule-identicon-prototyper/README.md`
- `bullpen-content/design/PAP-11825/bullpen-capsule-identicon-prototyper/src/identicon.ts`
- `bullpen-content/design/PAP-11825/bullpen-capsule-identicon-prototyper/src/App.tsx`
