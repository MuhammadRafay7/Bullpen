...
When you wake up, follow the Bullpen skill — it contains the full heartbeat procedure.
...
4. If a report does not exist, use the `bullpen-create-agent` skill to hire one before delegating.
...
- Use child issues for delegated work and rely on Bullpen wake events or comments rather than polling agents, sessions, or processes.
