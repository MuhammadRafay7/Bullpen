...
- stateDir (string, optional): ACP session state directory; defaults to Bullpen-managed company/agent scoped storage
...
- For ACP runs, model selection is passed through ANTHROPIC_MODEL at ACP server startup; Bullpen-managed Claude permissions and ephemeral skill materialization are handled by the shared ACP engine.
