...
const helperPath = path.resolve(__dirname, "../../skills/bullpen-task-bridge/bullpen-task.mjs");
...
describe("bullpen-task-bridge helper", () => {
  ...
  function env() {
    return {
      BULLPEN_API_URL: baseUrl,
      BULLPEN_BRIDGE_API_KEY: apiKey,
      BULLPEN_COMPANY_ID: "22222222-2222-4222-8222-222222222222",
      BULLPEN_AGENT_ID: "11111111-1111-4111-8111-111111111111",
      BULLPEN_RUN_ID: "66666666-6666-4666-8666-666666666666",
    };
  }
  ...
  it("creates tasks assigned to the authenticated agent by default", async () => {
    ...
    expect(createRequest?.headers["x-bullpen-run-id"]).toBe("66666666-6666-4666-8666-666666666666");
