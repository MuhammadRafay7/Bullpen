  ...
  return {
    fields: [
      ...
      },
      {
        ...
        type: "text",
        required: true,
        hint: "Hermes API_SERVER_KEY, not BULLPEN_API_KEY. Stored as a Bullpen secret reference.",
        meta: { secret: true },
      },
      {
      ...
      },
      {
        ...
        type: "text",
        hint: "Optional Bullpen API URL reachable by the remote Hermes host. This is not a credential.",
      },
      {
        key: "headers",
        label: "Extra headers",
