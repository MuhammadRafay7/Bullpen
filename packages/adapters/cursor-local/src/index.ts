...
Use when:
- You want Bullpen to run Cursor Agent CLI locally as the agent runtime
...
- Bullpen auto-injects local skills into "~/.cursor/skills" when missing, so Cursor can discover "$bullpen" and related skills on local runs.
- Bullpen auto-adds --yolo unless one of --trust/--yolo/-f is already present in extraArgs.
