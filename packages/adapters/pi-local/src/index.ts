...
Use when:
- You want Bullpen to run Pi (the AI coding agent) locally as the agent runtime
...
- Bullpen requires an explicit \`model\` value for \`pi_local\` agents.
- Sessions are stored in ~/.pi/bullpens/ and resumed with --session.
