...
describe("CompanyAccess", () => {
      ...
      members: [
        {
          ...
          user: {
            id: "user-1",
            email: "codexcoder@bullpen.local",
            name: "Codex Coder",
            image: null,
          },
          grants: [],
    ...
    listJoinRequestsMock.mockResolvedValue([
      {
        ...
        requestEmailSnapshot: "board@bullpen.local",
  ...
  it("keeps the page human-focused and hides advanced permission controls", async () => {
    ...
    expect(container.textContent).toContain("Manage the people who can work in Bullpen");
