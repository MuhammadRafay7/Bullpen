...
import type { AuthSession, CurrentUserProfile, UpdateCurrentUserProfile } from "@bullpen/shared";
...
export function ProfileSettings() {
  ...
  const uploadHint = selectedCompany
    ? `Stored in Bullpen file storage for ${selectedCompany.name}.`
    : "Select a company to upload an avatar into Bullpen storage.";
