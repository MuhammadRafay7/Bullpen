...
import { AGENT_ROLES, type AdapterEnvironmentTestResult, type AgentPermissions } from "@bullpen/shared";
...
export function NewAgent() {
  ...
  const availableSkills = (companySkills ?? []).filter((skill) => !skill.key.startsWith("bullpen/bullpen/"));
          ...
          <div className="space-y-3">
            <div>
              ...
              <p className="mt-1 text-xs text-muted-foreground">
                Optional skills from the company library. Built-in Bullpen runtime skills are added automatically.
              </p>
            </div>
