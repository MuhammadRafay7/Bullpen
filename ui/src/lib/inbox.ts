...
export const DISMISSED_KEY = "bullpen:inbox:dismissed";
export const READ_ITEMS_KEY = "bullpen:inbox:read-items";
export const INBOX_LAST_TAB_KEY = "bullpen:inbox:last-tab";
export const INBOX_ISSUE_COLUMNS_KEY = "bullpen:inbox:issue-columns";
export const INBOX_NESTING_KEY = "bullpen:inbox:nesting";
export const INBOX_GROUP_BY_KEY = "bullpen:inbox:group-by";
export const INBOX_FILTER_PREFERENCES_KEY_PREFIX = "bullpen:inbox:filters";
export const INBOX_COLLAPSED_GROUPS_KEY_PREFIX = "bullpen:inbox:collapsed-groups";
