...
export const AGENT_ORDER_UPDATED_EVENT = "bullpen:agent-order-updated";
export const AGENT_SORT_MODE_UPDATED_EVENT = "bullpen:agent-sort-mode-updated";
const AGENT_ORDER_STORAGE_PREFIX = "bullpen.agentOrder";
const AGENT_SORT_MODE_STORAGE_PREFIX = "bullpen.agentSortMode";
