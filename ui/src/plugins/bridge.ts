 ...
 * `useHostContext` from `@bullpen/plugin-sdk/ui`.  Those are type-only
 ...
 * registry on `globalThis.__bullpenPluginBridge__`), context propagation
...
/**
 * Resolve a plugin-provided Bullpen path to the active company scope.
 *
