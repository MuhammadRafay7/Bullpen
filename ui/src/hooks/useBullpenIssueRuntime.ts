...
export interface BullpenIssueRuntimeReassignment {
  assigneeAgentId: string | null;
  assigneeUserId: string | null;
}

export interface BullpenIssueRuntimeSendOptions {
  body: string;
  reopen?: boolean;
  reassignment?: BullpenIssueRuntimeReassignment;
}

interface UseBullpenIssueRuntimeOptions {
  messages: readonly ThreadMessage[];
  isRunning: boolean;
  onSend: (options: BullpenIssueRuntimeSendOptions) => Promise<void>;
...
export function useBullpenIssueRuntime({
  messages,
  isRunning,
  onSend,
  onCancel,
}: UseBullpenIssueRuntimeOptions) {
