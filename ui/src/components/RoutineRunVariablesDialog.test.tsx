...
import type { Agent, ExecutionWorkspace, Project, RoutineVariable } from "@bullpen/shared";
...
function createProject(): Project {
  return {
    ...
    codebase: {
      ...
      repoName: null,
      localFolder: null,
      managedFolder: "/tmp/bullpen/project-1",
      effectiveLocalFolder: "/tmp/bullpen/project-1",
