...
import { BullpenLoading } from "./AnimatedBullpenIcon";

describe("BullpenLoading", () => {
  it("renders an accessible full-page loading state", () => {
    const html = renderToStaticMarkup(<BullpenLoading />);
  ...
  it("allows containing layouts to override the full-page height", () => {
    const html = renderToStaticMarkup(<BullpenLoading className="min-h-0" />);
