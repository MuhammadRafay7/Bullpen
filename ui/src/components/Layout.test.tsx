...
const mockCompanyState = vi.hoisted(() => ({
  companies: [{ id: "company-1", issuePrefix: "PAP", name: "Bullpen" }],
  selectedCompany: { id: "company-1", issuePrefix: "PAP", name: "Bullpen" },
...
describe("Layout", () => {
  ...
  beforeEach(() => {
    ...
    mockCompanyState.companies = [{ id: "company-1", issuePrefix: "PAP", name: "Bullpen" }];
    mockCompanyState.selectedCompany = { id: "company-1", issuePrefix: "PAP", name: "Bullpen" };
  ...
  it("uses the route company context for plugin route sidebars on the first render", async () => {
    ...
    mockCompanyState.companies = [
      { id: "company-1", issuePrefix: "PAP", name: "Bullpen" },
