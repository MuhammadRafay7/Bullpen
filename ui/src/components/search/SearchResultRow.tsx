...
import { Bot, FileText, Hexagon, MessageSquare, Bullpen, Quote } from "lucide-react";
import type { Agent, CompanySearchResult } from "@bullpen/shared";
...
const SNIPPET_STYLES: Record<string, SnippetStyle> = {
  ...
  artifact: { Icon: Bullpen, label: "Artifact" },
...
function SearchResultRowImpl({
  ...
  if (result.type === "artifact") {
    ...
    return (
      ...
      >
        <Bullpen className="mt-1 h-4 w-4 shrink-0 text-muted-foreground" />
        <div className="min-w-0 flex-1">
