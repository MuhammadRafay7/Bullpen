...
import type { HeartbeatRun, Issue } from "@bullpen/shared";
...
function CompanyPatternIconMatrix() {
  const companies = [
    { name: "Bullpen Storybook", color: "#0f766e" },
...
function AsciiArtAnimationDemo({ loading = false }: { loading?: boolean }) {
  return (
    <StoryShell>
      <Section eyebrow="AsciiArtAnimation" title={loading ? "Loading art surface" : "Animated ASCII bullpen field"}>
