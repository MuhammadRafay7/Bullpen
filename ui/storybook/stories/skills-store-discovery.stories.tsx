...
const MOCK_CARDS: DiscoveryCard[] = [
  {
    key: "bullpen/bullpen/bullpen-dev",
    skillId: "s-dev",
    catalogRef: null,
    name: "bullpen-dev",
    slug: "bullpen-dev",
    author: "Bullpen",
    version: "v2.4.1",
    tagline: "Run and repair local Bullpen workspaces.",
    description: "Develop and operate a local Bullpen instance.",
  ...
  {
    key: "bullpen/bullpen/security-review",
    skillId: "s-sec",
    catalogRef: null,
  ...
  {
    key: "bullpen/bullpen/diagnose-why-work-stopped",
    skillId: "s-diag",
    catalogRef: "c-diag",
