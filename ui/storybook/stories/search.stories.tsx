...
import { storybookAgents, storybookProjects, storybookIssues } from "../fixtures/bullpenData";
...
function SearchStories() {
  return (
    <div className="bullpen-story">
      <main className="bullpen-story__inner max-w-[1320px] space-y-6">
        <section className="bullpen-story__frame p-6">
          <div className="bullpen-story__label">Search</div>
        ...
        <section className="bullpen-story__frame overflow-hidden">
          <div className="bullpen-story__title-block">
            <div className="bullpen-story__label">/search</div>
        ...
        <section className="bullpen-story__frame overflow-hidden">
          <div className="bullpen-story__title-block">
            <div className="bullpen-story__label">/search · screen 3</div>
        ...
        <section className="bullpen-story__frame overflow-hidden">
          <div className="bullpen-story__title-block">
            <div className="bullpen-story__label">/search · screen 1</div>
        ...
        <section className="bullpen-story__frame overflow-hidden">
          <div className="bullpen-story__title-block">
            <div className="bullpen-story__label">/search · screen 4</div>
        ...
        <section className="bullpen-story__frame overflow-hidden p-4">
          <div className="bullpen-story__title-block">
            <div className="bullpen-story__label">Match-source chips</div>
        ...
        <section className="bullpen-story__frame overflow-hidden p-4">
          <div className="bullpen-story__title-block">
            <div className="bullpen-story__label">Cmd+K palette</div>
        ...
        <section className="bullpen-story__frame overflow-hidden p-4">
          <div className="bullpen-story__title-block">
            <div className="bullpen-story__label">Search result row</div>
