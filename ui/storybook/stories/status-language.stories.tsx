...
import { AGENT_STATUSES, ISSUE_PRIORITIES, ISSUE_STATUSES } from "@bullpen/shared";
import type {
...
import { createIssue } from "../fixtures/bullpenData";
    ...
    <div className="bullpen-story">
      <main className="bullpen-story__inner space-y-6">
        <section className="bullpen-story__frame p-6">
          <div className="bullpen-story__label">Language</div>
