...
- Running a Python script that calls the Bullpen API
...
1. Bullpen spawns the configured command as a child process
2. Standard Bullpen environment variables are injected (`BULLPEN_AGENT_ID`, `BULLPEN_API_KEY`, etc.)
...
The script can use the injected environment variables to authenticate with the Bullpen API and perform work.
