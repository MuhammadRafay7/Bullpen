...
Bullpen supports three deployment configurations, from zero-friction local to internet-facing production.
...
- **Just trying Bullpen?** Use `local_trusted` (the default)
