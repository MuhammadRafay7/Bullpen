...
- `BULLPEN_APPROVAL_ID` — the resolved approval
- `BULLPEN_APPROVAL_STATUS` — `approved` or `rejected`
- `BULLPEN_LINKED_ISSUE_IDS` — comma-separated list of linked issue IDs
