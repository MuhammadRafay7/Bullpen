...
Manage companies within your Bullpen instance.
...
Company logo uploads use the normal Bullpen attachment size limit.
...
| `logoUrl` | string | Optional Bullpen asset content path for the stored logo image |
